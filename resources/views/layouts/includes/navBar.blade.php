<a href="#" class="btn btn-outline rounded-pill" data-toggle="modal" data-target="#sidebarmodal"><i
...
<a href="{{ route('products.barcode') }}" class="btn btn-outline rounded-pill"><i class="fa fa-chart"></i> Barcodes</a>
